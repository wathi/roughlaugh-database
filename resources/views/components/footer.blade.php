  ...
  <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div>
      ...
      <p class="text-base-content lg:text-sm text-xs ">
        This website is an unofficial fans site. For offical information, please visit <a href="https://roughlaugh-official.com/" target="_blank" class="text-blue-600 link link-hover">Rough×Laugh official website</a>.
      </p>
    </div>
      <div>
