<x-layout>
  <h1 class="text-2xl font-bold text-center mb-2">ROAD to ラフり隊</h1>
  <h2 class="text-xl text-center mb-8"></h2>
  @if(!$posts)
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <a href="{{ route('fans.show', ['id' => $post['id']]) }}" class="hover:underline">
